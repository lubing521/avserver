...
#define GM_SS_TYPE_G711     13
#define GM_SS_TYPE_G726     14
#define GM_SS_TYPE_AAC      15
#define GM_SS_AUDIO_MAX		15
...
int stream_reg(char *name, int vqno, char *vsdpstr, int aqno, char *asdpstr, int live, unsigned int mc_ip, int mc_port);
